...
function encryptMessage() {
	...
	var commonSecretKeyY = getN("commonSecretKeyY").value;

	var messageCipherText = sjcl.encrypt(commonSecretKeyY, messagePlainText);
...
function decryptMessage() {
	...
	var decryptedMessage = sjcl.decrypt(commonSecretKeyY, messageCipherText);
